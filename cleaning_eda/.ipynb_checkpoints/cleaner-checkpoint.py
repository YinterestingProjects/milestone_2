...
# def process_units(df):
#     # clean up incorrect units
#     index_num = df[df['unit'].isin(['N0','N','EA','MU','10','O','PC','ID','MO','PR','1','2'])].index
#     df.at[index_num,'unit']='NO'
#     index_num = df[df['unit'].isin(['GA','22','24'])].index
#     df.at[index_num,'unit']='GM'
#     index_num = df[df['unit'].isin(['GL'])].index
#     df.at[index_num,'unit']='KG'
    
#     # unify units 
#     df['unit_NO'] = df['unit'].isin(['NO'])
#     df['unit_KG'] = df['unit'].isin(['KG', 'GM', 'LB', 'MG'])
#     df['unit_LT'] = df['unit'].isin(['ML', 'LT', 'M3', 'CM3'])
#     df['unit_M'] = df['unit'].isin(['MT', 'CM'])
#     df['unit_M2'] = df['unit'].isin(['M2', 'C2'])
#     df['qty_new'] = np.NaN
